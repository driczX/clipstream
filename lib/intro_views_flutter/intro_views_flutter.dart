...
import 'package:clipstream/intro_views_flutter/Animation_Gesture/page_reveal.dart';
...
import 'package:clipstream/intro_views_flutter/Models/slide_update_model.dart';
import 'package:clipstream/intro_views_flutter/UI/page_indicator_buttons.dart';
import 'package:clipstream/intro_views_flutter/UI/pager_indicator.dart';
import 'package:clipstream/intro_views_flutter/UI/page.dart' as IntoUIPage;
...
class IntroViewsFlutter extends StatefulWidget {
  ...
  IntroViewsFlutter(
    ...
    this.pageButtonTextSize = 10.0,
    this.pageButtonFontFamily,
    this.onTapSkipButton,
    this.onTapNextButton,
    this.pageButtonsColor,
    this.doneText = const Text("Done"),
    this.nextText = const Text("Next", style: TextStyle(color: Colors.red)),
    this.skipText = const Text("Skip", style: TextStyle(color: Colors.red)),
...
class _IntroViewsFlutterState extends State<IntroViewsFlutter>
  ...
  Widget build(BuildContext context) {
    TextStyle textStyle = TextStyle(
            ...
            color: widget.pageButtonsColor ?? Colors.blue,
