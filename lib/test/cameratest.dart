...
//     if (controller != null) {
//       print((controller != null).toString() +
//           controller.value.isInitialized.toString() +
//           controller.value.isRecordingVideo.toString());
//     }
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//       mainAxisSize: MainAxisSize.max,
...
//     print("init camera" + cameraDescription.toString());
//     if (controller != null) {
...
class _CameraAppState extends State<CameraApp> {
  ...
  void initState() {
    ...
    try {
      ...
      print("123123" + cameras.isEmpty.toString());
    } on CameraException catch (e) {
      logError(e.code, e.description);
    }
  }
